...
public class PlacesController {
	...
	public String searchNearby(@RequestParam String lat, @RequestParam String lon, @RequestParam String radius,
			Model model) {
	...
	public String getRandom(@RequestParam String lat, @RequestParam String lon, @RequestParam String radius,
			Model model) {
	...
	public String searchWithFilters(@RequestParam String query, @RequestParam String cost,
			@RequestParam String foodType, @RequestParam String visitorCount, Model model) {
		List<Place> places = placesService.searchByFilters(query, cost, foodType, visitorCount);
		model.addAttribute("places", places);
		return "listeresultat";
	}
